...
class BertConfig(object):
    ...
    def __init__(
        ...
        max_position_embeddings=2048,#512
        type_vocab_size=2,
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.position_embeddings = nn.Embedding(config.max_position_embeddings//4, config.hidden_size)
        self.new_position_embeddings=nn.Embedding(config.max_position_embeddings, config.hidden_size)
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None):
        ...
        new_position_embeddings = self.new_position_embeddings(position_ids)
        # position_embeddings = self.position_embeddings(position_ids)
        token_type_embeddings = self.token_type_embeddings(token_type_ids)

        embeddings = inputs_embeds + new_position_embeddings + token_type_embeddings
