...
vocab_path = "/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/bert-base-cased/vocab_3utr.txt"  # bert模型字典的位置
...
model_path = "/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/cds23utr_model.93.bin"  # 模型位置
model_save_dir = "/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/"
batch_size = 4
lr = 1e-5
maxlen=2048
...
class Trainer:
    def __init__(self):
        # 加载数据
        src_dir = '/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/data/train/train_cds_unix.txt'
        tgt_dir = '/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/data/train/train_3utr_unix.txt'
        src_eval_dir='/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/data/val/val_cds_unix.txt'
        tgt_eval_dir='/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/data/val/val_3utr_unix.txt'
        ...
        # print(self.bert_model.cls.predictions.bias.size())
        # print(self.bert_model.cls.predictions.decoder.weight.size())
        # print(self.bert_model.cls.predictions.decoder.bias.size())
        # print(self.bert_model.bert.embeddings.word_embeddings.weight.size())
        # 声明需要优化的参数
    ...
    def eval_step(self,epoch):
        ...
        with torch.no_grad():
            ...
            for text in test_data:
                generater=trainer.bert_model.generate(text, beam_size=3)
                predicts.append(generater)
            for text_true in true_data:
...
if __name__ == '__main__':
    ...
    for epoch in range(94,200):
        ...
        if val_scores > best_score:
            ...
            model_save_path=os.path.join(model_save_dir,"cds23utr_model.{}.bin".format(epoch))
        ...
        tr_pd.to_csv('/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/tr_loss_3utr_200.csv')
        val_pd.to_csv('/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/val_loss_3utr_200.csv')
        jaccard_pd.to_csv('/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/jaccard_3utr_200.csv')
        rouge_pd.to_csv('/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/rouge_3utr_200.csv')
        bleu_pd.to_csv('/data2/zyfeng/zjgu/unilm/unilm/bert_seq2seq/result/bleu_3utr_200.csv')